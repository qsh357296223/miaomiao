<template>
   	<div class="city_body">
				...
				<div class="city_list">
					...
					<Scroller v-else ref="city_List"><div>
					<div class="city_hot">
						<h2>热门城市</h2>
						<ul class="clearfix">
					...
					<div class="city_sort" ref="city_sort">
						<div v-for="(item,index) in cityList" :key="index">
							<h2>{{item.index}}</h2>
							<ul>
								<li v-for="(itemList,index1) in item.list" :key="index1" @tap="handleToCity(itemList.nm,itemList.id)" >{{itemList.nm}}</li>
...
export default {
	...
	methods:{
		...
		handleToIndex(index){
			...
			//this.$refs.city_sort.parentNode.scrollTop = h2[index].offsetTop;  被scrooll管理  原生不能使用
